...
// cerrar sesion session_destroy();
   ...
   <div class="container-fluid">
     <h1 style="color:#FFFFFF"> <b>Usuario</h1>
    ...
    ?>
        <form action="CrudUsuario.php" method="get">
        <div class="container">
        <?php
        include("Config.php");
...
{echo '<tr align="center"> <td>'. $fila ["nombre"].'</td>
        ...
        <td><a href="CrudUsuario.php? id='. $fila["idUsuario"] .'" ><i class="bi bi-pencil-square"></i></td>
        <td><a href="EliminarUsuario.php? id='. $fila["idUsuario"].'" onclick="return Confirmareliminacion()"><i class="bi bi-trash"></i> </a></td></tr>';
}
?>
</table>
</div>
...
<a href="exelUsuario.php" class="btn btn-success" role="button"><span class="bi bi-filetype-xls"></span></a>
<a href="csvUsuario.php" class="btn btn-dark" role="button"><span class="bi bi-filetype-csv"></span></a>
<a href="pdfUsuario.php" class="btn btn-danger" role="button"><span class="bi bi-filetype-pdf"></span></a>
<a href="xmlUsario.php" class="btn btn-warning" role="button"><span class="bi bi-filetype-xml"></span></a>
<a href="jsonUsuario.php" class="btn btn-primary" role="button"><span class="bi bi-filetype-json"></span></a>
