...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Tabla Auto Usado',0,0,'C');
    // Salto de línea
    $this->Ln(20);

    $this->Cell(35,10,'Precio Transaccion',1,0,'C',0);
    ...
    $this->Cell(30,10,'Fecha Sesion',1,1,'C',0);
...
while ($fila = mysqli_fetch_array($datos))
{
    ...
    $pdf->Cell(30,10,$fila ["fechaCesion"],1,1,'C',0);
}
$pdf->Output();
?>
