...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Reporte2',0,0,'C');
    // Salto de línea
    $this->Ln(20);
    ...
    $this->Cell(30,10,'FechaSesion',1,0,'C',0);
    $this->Cell(30,10,'Nombre',1,0,'C',0);
    $this->Cell(30,10,'ApellidoP',1,0,'C',0);
    $this->Cell(30,10,'APellidoM',1,1,'C',0);
...
while ($fila = mysqli_fetch_array($datos))
{
    ...
    $pdf->Cell(30,10,$fila ["fechaCesion"],1,0,'C',0);
    $pdf->Cell(30,10,$fila ["nombre"],1,0,'C',0);
    $pdf->Cell(30,10,$fila ["apellidoPaterno"],1,0,'C',0);
    $pdf->Cell(30,10,$fila ["apellidoMaterno"],1,1,'C',0);
